...
export const UserDetailPage = () => {
    ...
    const [isSettinOpen, setIsSettingOpen] = useState(false);
    ...
    return (
        <PageContainer className="md:max-w-screen-lg">
            ...
            <PageContent variant="card">
                {isSettinOpen ? <UserSetting data={data} onClose={() => setIsSettingOpen(false)} /> :
                        ...
                        <>
                            <div className="flex flex-col md:flex-row justify-between md:items-start">
                                ...
                                <div className="flex items-center gap-2 p-6 pr-3 pb-3 justify-end">
                                    <Button variant="ghost" size="sm" className="text-sm hover:drop-shadow-md" onClick={() => setIsEditModalOpen(true)}> <PencilIcon className="w-4 h-4 mr-2" /> Edit</Button>
                                    <Button variant="ghost" size="sm" className="text-sm hover:drop-shadow-md" onClick={() => setIsSettingOpen(true)}> <SettingsIcon className="w-4 h-4 mr-2" /> Setting</Button>
                                </div>
                            </div>
