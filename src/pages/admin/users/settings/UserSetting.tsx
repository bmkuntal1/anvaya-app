    ...
    return (
        <div className="flex flex-col gap-4 p-6">
            <div className="flex flex-row justify-between items-start">
                ...
                <Button variant="ghost" size="sm" className="text-sm hover:drop-shadow-md" onClick={onClose}> <X className="w-4 h-4 mr-1" /><span className="hidden md:block">Close</span></Button>
            </div>
